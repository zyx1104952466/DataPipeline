 ...
 */
public class disData20241030to20241106Test extends BaseFileOperations {

    /**
     * .xlsx文件路径
     */
    public static final String SOURCE_FILE = "E:\\日常迭代\\计费重构二期\\20241107\\202410计费比对差异.xlsx";
    public static final String SOURCE_FILE1 = "E:\\日常迭代\\计费重构二期\\20241107\\双重计费-费率固定金额为0-最小金额不为0.xlsx";
    ...
    public void test() throws IOException {
        ...
        for (int i = 1; i < records.size(); i++) { // 跳过标题行
            ...
            try {
                String logNo = record.get(0);
                String userCode = record.get(2);
                String newFeeResultInfoSnapshot = record.get(12);
                String paramsJson = record.get(10);
                String oldFeeRspSnapshot = record.get(11);
